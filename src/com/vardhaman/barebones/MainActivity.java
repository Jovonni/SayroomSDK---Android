package com.vardhaman.barebones;
...
import com.vardhaman.barebones.R;
...
public class MainActivity extends Activity implements OnClickListener{
	...
	private String url_upload_audio_tasks = "http://api.sayroom.com/v1/sayroomModel/recordUploadTasks";
	private String url_verify_user = "";
...
//	        	new VerifyUser().execute();
	        ...
	        public void userUploadAudioForImage(String userID,String brandImageID,String userCurrentLocation){
	        	new UploadAudioForImage(userID, brandImageID, userCurrentLocation,mFileName).execute();
	        }
	        
	        public void userUploadAudioForTask(String userID,String brandTaskID,String userCurrentLocation){
	        	new UploadAudioForTask(userID, brandTaskID, userCurrentLocation,mFileName).execute();
	        }
