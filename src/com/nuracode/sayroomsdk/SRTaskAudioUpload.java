...
public class SRTaskAudioUpload extends AsyncTask<String, String, String> {
	...
	public SRTaskAudioUpload(String userID, String brandTaskID, String userCurrentLocation,String fileName) {
	...
	protected void onPreExecute() {
		//pDialog = ProgressDialog.show(MainActivity, "Uploading Audio", "Please wait..");
		onPreExecute();
	}
